...
def product(*iterables, repeat=1): return list(itertools.product(*iterables, repeat=repeat))
def permutations(iterable, r=None): return list(itertools.permutations(iterable, r=r))
...
def accumulate(iterable, func=operator.add): return list(itertools.accumulate(iterable, func=func))
...
def zip_longest(*iterables, fillvalue=None): return list(itertools.zip_longest(*iterables, fillvalue=fillvalue))
def count(start=0, step=1): return list(itertools.count(start=start, step=step))
def cycle(iterable): return list(itertools.cycle(iterable))
def repeat(object, times=None): return list(itertools.repeat(object, times=times))
